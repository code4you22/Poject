...
public class PAGE5 {
	...
	private JTextField textFieldiquantity;
	private JTextField textFieldisprice;
	private JTextField textFieldiodate;
	private JTextField textFieldmid;
	private JTextField textFieldmname;
	private JTextField textFieldmtype;
	private JTextField textFieldmquantity;
	private JTextField textFieldmedate;
	private JTextField textFieldmsprice;
	private JTextField textFieldmodate;
	...
	private void initialize() {
		...
		JLabel lblNewLabel_1 = new JLabel("           OPENING     STOCK         ");
		...
		rdbtnNewRadioButton.setBounds(137, 28, 133, 23);
		...
		lblNewLabel_3.setBounds(67, 0, 114, 20);
		...
		textFieldiid.setBounds(144, 22, 86, 20);
		panel_3.add(textFieldiid);
		textFieldiid.setColumns(10);
		
		textFieldiname = new JTextField();
		textFieldiname.setBounds(144, 63, 86, 20);
		panel_3.add(textFieldiname);
		textFieldiname.setColumns(10);
		
		textFielditype = new JTextField();
		textFielditype.setBounds(144, 107, 86, 20);
		panel_3.add(textFielditype);
		textFielditype.setColumns(10);
		
		textFieldiquantity = new JTextField();
		textFieldiquantity.setBounds(144, 148, 86, 20);
		panel_3.add(textFieldiquantity);
		textFieldiquantity.setColumns(10);
		
		textFieldisprice = new JTextField();
		textFieldisprice.setBounds(144, 194, 86, 20);
		panel_3.add(textFieldisprice);
		textFieldisprice.setColumns(10);
		
		textFieldiodate = new JTextField();
		textFieldiodate.setBounds(144, 235, 86, 20);
		panel_3.add(textFieldiodate);
		textFieldiodate.setColumns(10);
		...
		lblNewLabel_10.setBounds(68, 0, 133, 20);
		...
		lblNewLabel_12.setBounds(10, 55, 101, 14);
		...
		textFieldmid.setBounds(142, 21, 86, 20);
		panel_4.add(textFieldmid);
		textFieldmid.setColumns(10);
		
		textFieldmname = new JTextField();
		textFieldmname.setBounds(142, 52, 86, 20);
		panel_4.add(textFieldmname);
		textFieldmname.setColumns(10);
		
		textFieldmtype = new JTextField();
		textFieldmtype.setBounds(142, 88, 86, 20);
		panel_4.add(textFieldmtype);
		textFieldmtype.setColumns(10);
		
		textFieldmquantity = new JTextField();
		textFieldmquantity.setBounds(142, 127, 86, 20);
		panel_4.add(textFieldmquantity);
		textFieldmquantity.setColumns(10);
		
		textFieldmedate = new JTextField();
		textFieldmedate.setBounds(142, 163, 86, 20);
		panel_4.add(textFieldmedate);
		textFieldmedate.setColumns(10);
		
		textFieldmsprice = new JTextField();
		textFieldmsprice.setBounds(142, 199, 86, 20);
		panel_4.add(textFieldmsprice);
		textFieldmsprice.setColumns(10);
		
		textFieldmodate = new JTextField();
		textFieldmodate.setBounds(142, 235, 86, 20);
		panel_4.add(textFieldmodate);
		textFieldmodate.setColumns(10);
		
		
		//JPanel panel_3;
		panel_5 = new JPanel();
		panel_5.setBounds(575, 51, 124, 332);
		panel.add(panel_5);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try{
					String query="insert into opening_stock(iid,iname,itype,iquantity,isprice,iodate,mid,mname,mtype,mquantity,medate,msprice,modate) values(?,?,?,?,?,?,?,?,?,?,?,?,?)";
				    ...
				    pst.setString(4,textFieldiquantity.getText()  );
					pst.setString(5,textFieldisprice.getText() );
					pst.setString(6,textFieldiodate.getText() );
					pst.setString(7,textFieldmid.getText() );
					pst.setString(8,textFieldmname.getText()  );
					pst.setString(9, textFieldmtype.getText() );
					pst.setString(10,textFieldmquantity.getText() );
					pst.setString(11,textFieldmedate.getText()  );
					pst.setString(12, textFieldmsprice.getText() );
					pst.setString(13,textFieldmodate.getText() );
					pst.execute();
		...
		btnNewButton.setBounds(10, 71, 89, 23);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try
				{
					String query="delete from opening_stock where iid='"+textFieldiid.getText()+"' ";
					PreparedStatement pst=connec.prepareStatement(query);
					pst.execute();
		...
		btnNewButton_1.setBounds(10, 245, 89, 23);
