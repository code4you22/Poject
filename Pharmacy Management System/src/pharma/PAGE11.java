...
public class PAGE11 {
	...
	private void initialize() {
		...
		panel.setBounds(0, 155, 657, 406);
		frame.getContentPane().add(panel);
		panel.setLayout(null);
		
		JLabel lblNewLabel_1 = new JLabel("DATA RECORD");
		lblNewLabel_1.setBounds(229, 11, 93, 14);
		panel.add(lblNewLabel_1);
		
		JPanel panel_1 = new JPanel();
		panel_1.setBounds(667, 213, 117, 237);
		...
		btnNewButton.setBounds(10, 41, 89, 23);
		panel_1.add(btnNewButton);
		
		JButton btnNewButton_1 = new JButton("EDIT");
		btnNewButton_1.setFont(new Font("Tahoma", Font.BOLD, 11));
		btnNewButton_1.setBounds(10, 182, 89, 23);
